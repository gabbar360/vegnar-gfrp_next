...
const blogPosts = [
  ...
  },
  {
    ...
    excerpt: 'Learn how GFRP rebars contribute to sustainable construction practices and reduce environmental impact.',
    author: 'Amit Patel',
    date: '2024-01-05',
  ...
  },
  {
    ...
    excerpt: 'A comprehensive guide to proper installation techniques for GFRP rebars to ensure optimal performance.',
    author: 'Dr. Rajesh Kumar',
    date: '2023-12-28',
    category: 'Technical',
            ...
            <div className="lg:col-span-3">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
                {currentPosts.map((post) => (
                  <Card key={post.id} className="group hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 border-[#9e5020]/20">
